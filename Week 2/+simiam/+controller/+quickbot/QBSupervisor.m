...
%                 fprintf('already in state %s\n', name);
        ...
        %   measured wheel encoder tick counts are stored in prev_ticks.
            ...
            x_dt = (right_ticks-prev_right_ticks + left_ticks-prev_left_ticks)*m_per_tick*cos(theta)/2;
            y_dt = (right_ticks-prev_right_ticks + left_ticks-prev_left_ticks)*m_per_tick*sin(theta)/2;
            theta_dt = (right_ticks-prev_right_ticks - left_ticks+prev_left_ticks)*m_per_tick/L;
